...
- Machine non-whitespace character counts are diagnostic mappings only. If the machine count and Chinese-content count disagree, use the Chinese-content count for pass/fail and record the mapping in review or manifest evidence.
