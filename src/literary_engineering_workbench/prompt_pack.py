...
6. 默认禁用机械“不是……而是……”“并非……而是……”“与其说……不如说……”以及“不是……——是……”“不是……。是……”“不是……，是……”等变体。只有 Style Skill 或用户明确授权其作为功能性修辞时才可例外；例外必须承担人物认知、信息纠偏、讽刺顿挫或叙述者节奏功能。
7. 未获文风授权时，同一自然段破折号原则上不超过 2 处，全场景破折号总数原则上不超过 12 处；获授权的高破折号文风也必须区分功能性停顿和机械装饰，不能让破折号替代因果、动作或心理呈现。
8. 若文风要求与 canon、人物逻辑、场景因果或用户明确要求冲突，保留硬事实，在“需要人工确认”中说明冲突，不要用文风掩盖逻辑问题。
9. 输出前做内部自检：正文是否先服从了文风机制，是否降低 AI 腔，是否仍保持人物和剧情因果。不要把自检过程、风格分析或工作流痕迹写进正文候选。
"""
...
正文必须降低 AI 腔：默认禁用机械“不是……而是……”“并非……而是……”“与其说……不如说……”以及“不是……——是……”“不是……。是……”等变体；除非 Style Skill 或用户明确授权其作为功能性修辞。避免抽象总结、解释性心理标签、模板化转折、对称排比、全知说教和结尾金句化。
不要用脚本化思维改写正文：生成时避免问题，修订时逐句语义判断；不得把否定、纠偏、讽刺顿挫或人物心理误删成反义。
...
7. 标点与 AI 腔：遵守标准中文标点，默认禁用机械“不是……而是……”和“不是……——是……”等变体；若 Style Skill 明确授权，必须让其承担信息纠偏、人物认知或叙述节奏功能。转折由动作、信息差、因果和人物选择产生，避免抽象总结、解释性心理标签、模板转折、对称排比和金句化收束。
