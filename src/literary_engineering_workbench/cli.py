...
def build_parser() -> argparse.ArgumentParser:
    ...
    promote_asset.add_argument("--allow-unapproved", action="store_true")
    ...
    state_apply.add_argument("--allow-unapproved", action="store_true", help="Apply without approve record for internal experiments.")
    state_apply.add_argument("--allow-unresolved", action="store_true", help="Apply even when the patch has unresolved changes.")
    ...
    publish.add_argument("--allow-unapproved", action="store_true", help="Allow internal release without an approve record.")
