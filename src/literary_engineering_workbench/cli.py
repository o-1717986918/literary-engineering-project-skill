...
def build_parser() -> argparse.ArgumentParser:
    ...
    workflow_state.add_argument("--route", default="scene-development", help="Route key. Supports scene-development, longform-planning, source-ingest, style-engineering, and overall.")
    ...
    task_next.add_argument("--route", default="scene-development", help="Route key. Supports scene-development, longform-planning, source-ingest, and style-engineering.")
    ...
    workflow_advance.add_argument("--route", default="scene-development", help="Route key. Supports scene-development, longform-planning, source-ingest, and style-engineering.")
