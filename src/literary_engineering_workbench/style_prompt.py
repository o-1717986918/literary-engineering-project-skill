...
- 不要把作者风格简化为“句号很多”“破折号很多”“但是/然而很多”。必须说明句号、逗号、分号、破折号和转折词分别服务什么叙事功能；若作者确有高破折号或“不是 A——是 B”式否定纠偏结构，必须写清它在何种语义场景可用、何时禁用，以及如何避免模型机械复制。
- 降低 AI 腔部分必须采用“默认禁用、明确例外”的写法：未经用户或本 Style Skill 明确授权，不使用机械“不是……而是……”“并非……而是……”“与其说……不如说……”及“不是……——是……”变体；如需保留，必须绑定人物认知、信息反转、讽刺顿挫或叙述者纠偏功能。
- 不摘抄原文，不制造不可验证的作者论断。
...
- 默认禁用机械“不是……而是”及“不是……——是”等变体；只有本文风授权，且承担认知二分、信息反转、讽刺顿挫或叙述者纠偏功能时才保留。
...
- 是否降低 AI 腔：没有未经授权的机械对照、破折号转折变体、抽象总结、解释性心理标签、模板化转折、对称排比或金句化收束。
- 是否避免复制原文连续表达。
