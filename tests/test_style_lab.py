...
中文正文使用全角标点，省略号用“……”，破折号用“——”。句号用于真实语义、镜头或心理落点；逗号用于未完成关系；分号用于层级并列；破折号只用于打断、插入、骤变、信息纠偏或强解释性补充。转折优先由动作、视线、意象、信息差和因果推进完成；未经文风授权，不把破折号当成“而是/但是/于是”的替代品。

## 降低 AI 腔控制

默认禁用机械“不是……而是……”“并非……而是……”以及“不是……——是……”等变体；只有文风明确授权且承担人物认知、信息反转、讽刺顿挫或叙述者纠偏功能时才保留。不要用抽象总结、解释性心理标签、模板化转折、对称排比或结尾金句替代具体叙事。人物认知变化应通过动作、停顿、回避、误判、语气和对白潜台词呈现。
